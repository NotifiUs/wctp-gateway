<div class="modal fade" data-backdrop="static" id="enableEnterpriseHostModal{{ $host->id }}" tabindex="-1" role="dialog" aria-labelledby="enableEnterpriseHostModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content shadow-sm border-success">
            <div class="modal-header">
                <h5 class="modal-title" id="enableEnterpriseHostModalLabel{{ $host->id }}">{{ __('Enable Enterprise Host') }}</h5>
