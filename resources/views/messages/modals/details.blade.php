<div class="modal fade" data-backdrop="static" id="detailsMessageModal{{ $message->id}}" tabindex="-1" role="dialog" aria-labelledby="detailsMessageModal" aria-hidden="true">
