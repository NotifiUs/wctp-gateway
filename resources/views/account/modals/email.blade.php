<div class="modal fade" data-backdrop="static" id="editEmailModal" tabindex="-1" role="dialog"
            ...
            <form method="POST" action="/account/email" role="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Your email address for password resets and
                            notifications.</small>
                    </div>
                    ...
                    <div class="form-group bg-light border py-3 px-2 rounded shadow-sm">
                        <div class="form-check">
                            <input
                                @if($user->email_notifications){{ ' checked="checked"' }}@endif class="form-check-input"
                                type="checkbox" value="1" id="email_notifications" name="email_notifications">
