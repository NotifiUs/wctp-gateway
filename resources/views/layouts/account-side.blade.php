...
<ul class="list-group rounded">
    <a class="list-group-item list-group-item-action" href="#" data-bs-toggle="modal" data-bs-target="#editNameModal">
    ...
    @else
        <a class="list-group-item list-group-item-action" href="#" data-bs-toggle="modal" data-bs-target="#editEmailModal">
            <i class="fas fa-at text-primary"></i> {{ __('Update email settings') }}
        </a>
    @endif
    <a class="list-group-item list-group-item-action" href="#" data-bs-toggle="modal" data-bs-target="#editTimezoneModal">
        <i class="fas fa-clock text-primary"></i> {{ __('Select timezone') }}
    </a>
    <a class="list-group-item list-group-item-action" href="#" data-bs-toggle="modal" data-bs-target="#editPasswordModal">
