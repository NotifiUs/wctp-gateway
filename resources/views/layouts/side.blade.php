    ...
    <ul class="list-group rounded">
        <a href="/home" class="list-group-item list-group-item-action @if( Str::startsWith(request()->path(), 'home') ) {{ " active " }} @endif">
            <i class="fas fa-tachometer-alt text-primary"></i> {{ __('Dashboard') }}
        </a>
        <a href="/hosts" class="list-group-item list-group-item-action @if( Str::startsWith(request()->path(), 'hosts' )) {{ " active " }} @endif">
            <i class="fas fa-cube text-primary"></i> {{ __('Enterprise Hosts') }}
        </a>
        <a href="/carriers" class="list-group-item list-group-item-action @if( Str::startsWith(request()->path(), 'carriers') ) {{ " active " }} @endif">
            <i class="fas fa-sim-card text-primary"></i> {{ __('Carrier APIs') }}
        </a>
        <a href="/numbers" class="list-group-item list-group-item-action @if( Str::startsWith(request()->path(), 'numbers') ) {{ " active " }} @endif">
