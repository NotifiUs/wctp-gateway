    ...
    <h5 class="text-muted-light">{{ __('Core Services') }}</h5>
    ...
    <ul class="list-group rounded">
        ...
        <li class="list-group-item">
            ...
            <div class="float-right w-25">
                <div class="progress">
                    <div class="progress-bar bg-info" role="progressbar" style="width: {{ $server['disk']['percent'] }}%;" aria-valuenow="{{ $server['disk']['value'] }}" aria-valuemin="0" aria-valuemax="{{ $server['disk']['total'] }}"></div>
                </div>
            </div>
        </li>
    </ul>
