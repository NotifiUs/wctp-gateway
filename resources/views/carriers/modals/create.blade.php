<div class="modal fade" data-backdrop="static" id="createCarrierModal" tabindex="-1" role="dialog" aria-labelledby="createCarrierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content shadow-sm border-primary">
            <div class="modal-header">
                <h5 class="modal-title" id="createCarrierModalLabel">{{ __('Add Carrier') }}</h5>
            ...
            <form method="POST" action="/hosts" role="form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Verify Carrier</button>
                </div>
            </form>
        </div>
    </div>
