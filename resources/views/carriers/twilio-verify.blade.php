    ...
    <div class="row justify-content-start mb-2">
        @if( $account['sid'] == $account['ownerAccountSid'] )
            <div class="alert alert-warning w-100" role="alert">
                <i class="fas fa-exclamation-triangle"></i> <strong>Master Account</strong> detected. We recommend using
                a <strong>SubAccount</strong> whenever possible.
            </div>
        @endif

        @if( $account['type'] !== 'Full' )
            <div class="alert alert-info w-100" role="alert">
                <i class="fas fa-exclamation-circle"></i> <strong>Trial Account</strong> detected. Please upgrade your
                Twilio account before going into production.
            </div>
        @endif

        @if( $account['status'] !== 'active' )
            <div class="alert alert-danger w-100" role="alert">
                <i class="fas fa-exclamation"></i> Account <strong>inactive</strong>. You must restore the account to
